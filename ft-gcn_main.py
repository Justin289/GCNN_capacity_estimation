...
def train_optuna(trial):
    params_train = {
        'learning_rate': trial.suggest_categorical('learning_rate', [0.01, 0.02, 0.03, 0.001, 0.005, 0.0005, 0.0001, 0.00001]),
        ...
        # 'window_len': trial.suggest_categorical("window_len", [50,100,120,200]),
        'interval': trial.suggest_categorical("interval", [50,80,100,200]),
        'window_limit': trial.suggest_categorical("window_limit", [5,10,20,50,100]),
    }
    parser = argparse.ArgumentParser(description='Automatic parameter setting')
    parser.add_argument('--config_path', type=str,
                        default=os.path.join(os.path.dirname(os.getcwd()), '/log/weiyian/log/finetuning/configs/model_configs.json'))
